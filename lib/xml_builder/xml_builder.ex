defmodule XmlGen do
  ...
  ## Examples
      ...
      iex> XmlGen.document(:person) |> XmlGen.generate
      "<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?>\\n<person/>"

      iex> XmlGen.document(:person, "Josh") |> XmlGen.generate
      "<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?>\\n<person>Josh</person>"

      iex> XmlGen.document(:person) |> XmlGen.generate(format: :none)
      "<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?><person/>"

      iex> XmlGen.element(:person, "Josh") |> XmlGen.generate
      "<person>Josh</person>"

      iex> XmlGen.element(:person, %{occupation: "Developer"}, "Josh") |> XmlGen.generate
  ...
  ## Examples
      ...
      iex> XmlGen.element(:person)
      {:person, nil, nil}

      iex> XmlGen.element(:person, "data")
      {:person, nil, "data"}

      iex> XmlGen.element(:person, %{id: 1})
      {:person, %{id: 1}, nil}

      iex> XmlGen.element(:person, %{id: 1}, "data")
      {:person, %{id: 1}, "data"}

      iex> XmlGen.element(:person, %{id: 1}, [XmlGen.element(:first, "Steve"), XmlGen.element(:last, "Jobs")])
      {:person, %{id: 1}, [
        {:first, nil, "Steve"},
        {:last, nil, "Jobs"}
      ]}
  ...
  ## Examples
      ...
      iex> XmlGen.generate(XmlGen.element(:person))
      "<person/>"

      iex> XmlGen.generate({:person, %{id: 1}, "Steve Jobs"})
      "<person id=\\\"1\\\">Steve Jobs</person>"

      iex> XmlGen.generate({:name, nil, [{:first, nil, "Steve"}]}, format: :none)
      "<name><first>Steve</first></name>"

      iex> XmlGen.generate({:name, nil, [{:first, nil, "Steve"}]}, whitespace: "")
      "<name>\\n<first>Steve</first>\\n</name>"

      iex> XmlGen.generate({:name, nil, [{:first, nil, "Steve"}]})
      "<name>\\n  <first>Steve</first>\\n</name>"

      iex> XmlGen.generate(:xml_decl, encoding: "ISO-8859-1")
